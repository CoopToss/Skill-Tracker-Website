...
def upgrade():
    ...
    op.add_column('skill', sa.Column('user_id', sa.Integer, sa.ForeignKey('user.id')))
    op.add_column('skill', sa.Column('goal_details', sa.Text(), nullable=True))
...
def downgrade():
    ...
    op.drop_column('skill', 'goal_details')
    # ### end Alembic commands ###
